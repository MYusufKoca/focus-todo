...
export default function TodoList({ todos, hasTodos, onNewTodo, onToggle, onDelete, onEdit, onClearFilters }) {
  if (!hasTodos) return <EmptyState onNewTodo={onNewTodo} />
  if (todos.length === 0) return <NoFilterResults onClearFilters={onClearFilters} />
